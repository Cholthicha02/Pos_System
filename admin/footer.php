  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 POS System <a href="https://computing.kku.ac.th/index">college of computing kku</a>.</strong> All rights
    reserved.
  </footer>
...
<script>
  Swal.fire({
  title: 'สำเร็จ',
  text: 'แก้ไขรายละเอียดสินค้าสำเร็จ',
  icon: 'success',
  confirmButtonText: 'ตกลง'
})
</script>
