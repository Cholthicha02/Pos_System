          ...
          <div class="col-md-12">
            <table id="example1" class="table table-bordered  table-hover table-striped">
              ...
              <tbody class="text-center">
                ...
                <tr>
                  <td class="align-middle"><?php echo @$l+=1; ?></td>
                  <td class="align-middle"><center><img src="../p_img/<?php echo $row_product['p_img']; ?>" width="80%"></center></td>
                  <td class="align-middle"><?php echo $row_product['p_name']; ?></td>
                  <!-- <td class="align-middle"><?php echo $row_product['p_detail']; ?></td> -->
                  <td class="align-middle"><?php echo $row_product['p_price']; ?></td>
                  <td class="align-middle"><?php echo $row_product['p_qty']; ?></td>
                  
                  <td class="align-middle"><a href="product_edit.php?p_id=<?php echo $row_product['p_id']; ?>" class="btn btn-warning"><i class="fas fa-pencil-alt"></i> edit</a></td>
                  <td class="align-middle"><a href="product_db.php?p_id=<?php echo $row_product['p_id']; ?>&&product=del" class="del-btn btn btn-danger"><i class="fas fas fa-trash"></i> del</a></td>
